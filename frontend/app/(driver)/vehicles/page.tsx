    ...
    >
      ...
      {error && (
        <p
          ...
          data-testid="edit-vehicle-error"
        >
          {error}
        </p>
      )}
...
function VehicleCard({
  ...
  return (
    ...
    >
            ...
            {!confirmDelete ? (
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  className="rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-700 hover:bg-slate-200"
                  data-testid="vehicle-cancel-delete-btn"
                >
                  No
                </button>
              </div>
      ...
      {deleteError && (
        <p
          className="mt-2 rounded-lg bg-red-50 px-3 py-1.5 text-xs text-red-700"
          data-testid="vehicle-delete-error"
        >
          {deleteError}
        </p>
      )}
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-semibold" data-testid="vehicles-heading">
          Mis Vehículos
        </h1>
        <button
      ...
      {loading ? (
        <div className="space-y-3" data-testid="vehicles-loading">
          {[1, 2].map((i) => (
